...
class ProtectedImageUploader {
    ...
    /** @var ProtectedImageUploader */
    private static $instance;

    private function __construct() {
        static::$instance = $this;
        $this->base_path = rtrim(\Config\Config::F()->PROTECTED_STORAGE_BASE, DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR;
    }

    public static function F(): ProtectedImageUploader {
