 ...
 * @author eve
 */
class PreplayController extends AbstractAdminController {

    public function get_desktop_component_id() {
        return "desktop.preplay";
    }
    ...
    public function API_list() {
        \Content\MediaContent\Preplay\Lister::F(\DataMap\PostDataMap::F())->run($this->out);
    }
    ...
    public function API_get(string $rid = null) {
        ...
        $promo = \Content\MediaContent\Preplay\Preplay::F($id);
    ...
    public function API_put() {
        ...
        $ret_id = \Content\MediaContent\Preplay\Writer::F(\DataMap\CommonDataMap::F()->rebind($data))->run()->result_id;
        $this->API_get($ret_id);
    }
    ...
    public function API_remove() {
        ...
        if ($id) {
            \Content\MediaContent\Preplay\Remover::F($id)->run();
        }
        $this->API_list();
    }
