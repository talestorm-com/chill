...
class VideoGroupWriter {
     ...
     * @return \Content\Video\Writer\VideoGroupWriter
     */
    public static function F(\DataMap\IDataMap $data_input, \DataMap\IDataMap $common_input): VideoGroupWriter {
