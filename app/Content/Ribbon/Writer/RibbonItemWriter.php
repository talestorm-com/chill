...
class RibbonItemWriter {
     ...
     * @return \Content\Ribbon\Writer\RibbonItemWriter
     */
    public static function F(\DataMap\IDataMap $data_input, \DataMap\IDataMap $common_input): RibbonItemWriter {
