...
function smarty_function_display_menu_lent($aparams, $smtpl) {
    ...
    $lent = \Content\MediaContentRibbon\V2\MenuLent::F(Language\LanguageList::F()->get_current_language(), $requested_page);    
