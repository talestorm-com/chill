...
//</editor-fold>
    ...
    public function __construct(string $encode_image_b64) {
        $tmp_nam = tempnam($this->get_tmp_dir(), "fakefile_");
     ...
     * @return \static
     */
    public static function F(string $field_name, array $data = null) {
