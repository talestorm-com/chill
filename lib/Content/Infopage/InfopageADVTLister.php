...
class InfopageADVTLister {
    ...
    public function run() {
        ...
        $qt = "SELECT SQL_CALC_FOUND_ROWS id,alias,title,published FROM infopage %s %s %s %s;";
        $c = 0;
        $p = [];
     ...
     * @param \DB\IDBAdapter $adapter
     * @param \ADVTable\Data\IData $input
     * @return \Content\Infopage\InfopageADVTLister
     */
    public static function F(\Out\IOut $out, \DB\IDBAdapter $adapter = null, \ADVTable\Data\IData $input = null): InfopageADVTLister {
