...
class ContentBlockADVTLister {
    ...
    public function run() {
        ...
        $qt = "SELECT SQL_CALC_FOUND_ROWS id,alias,comment FROM content_block %s %s %s %s;";
        $c = 0;
        $p = [];
     ...
     * @param \DB\IDBAdapter $adapter
     * @param \ADVTable\Data\IData $input
     * @return \Content\ContentBlock\ContentBlockADVTLister
     */
    public static function F(\Out\IOut $out, \DB\IDBAdapter $adapter = null, \ADVTable\Data\IData $input = null): ContentBlockADVTLister {
