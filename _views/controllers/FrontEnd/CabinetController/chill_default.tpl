                ...
                <form method="GET" action="/Cabinet/money_money_money" id="moneyform">
                    <div class="row">
                        ...
                        <div class="col s12 l6">
                            ...
                            <input type='hidden' id='payment_token' name='token' value='{$controller->mk_csrf('wallet')}' />
                    ...
                    <div class="row">
                        ...
                        <div class="col s6 l4">
                            ...
                            <div class="one_lk_form_input">
                                ...
                                <input type='hidden' id='promo_token' name='promo_token' value='{$controller->mk_csrf('promo')}' />
                            </div>
                        </div>
                        <div class="col s6 l2">
                            <div class="lk_btn_akt">
                ...
                <div class="row">
                    <div class="col s12 l6">
                        ...
                        <div class="one_lk_form_block">
                            ...
                            <input type="text" readonly="readonly" value="{$referal_link}" id="referal_link_value" />
                            <div class="lk_btn_akt">
                        ...
                        <div class="col s12 l6">
                            <div class="one_lk_form_block">
                                ...
                                <div class="one_lk_form_input">
                                    ...
                                    <input type='hidden' name='token' id='cabinet_token' value='{$controller->mk_csrf('profile')}' />
                                </div>
                            </div>
                            <!-- <div class="one_lk_form_block">
