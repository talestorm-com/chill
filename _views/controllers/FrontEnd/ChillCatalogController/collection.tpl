...
<div class="film_left film_left_aa">
                    ...
                    <img src="/media/media_content_poster/{$soap->id}/{$soap->default_poster}.SW_400H_520CF_1.jpg" loading="lazy">
                    {else}
            ...
            {if $soap->track_language_name}
                ...
                <div class="one_film_prop"><span>{if $soap->seasons_count}{$soap->seasons_count}{/if} {TT  t='season'} ({if $soap->series_count}{$soap->series_count}{/if} {TT  t='series_lent'})</span></div>
                    ...
                    <div style="color:white;padding:1em;">{if $collection->additional_content}{$collection->additional_content}{/if}</div>
                </div>
            </div>
        </div>
    </div>
