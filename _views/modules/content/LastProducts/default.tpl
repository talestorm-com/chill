{if ($this->length>0)}
    ...
    <div class="LastSeenProductsModule BeforeFooterOffset">
        <div class="TileBlock TileBlock-ProductLine TileBlock-custom-LastSeenGenerated" id="tileblock_{$tileblock_uuid}">
            <div class="TileBlockInner">            
                <div class="TileBlockHeader">Вы недавно смотрели:
                ...
                <div class="TileBlockContentFrame">
                    <div class="TileBlockContent" style="width:{(18.64*count($this)+1.7*(count($this)-1))|format_percent:'vw'}">
