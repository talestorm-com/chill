...
<div class="trailer_backdrop" id="{$trailer_player_uuid}" style="display:none">
    ...
    <div class="go_to_cinema">
        <a class="promo-btn" href="" onclick="window.open(this.href+'#login_open','_self');return false;">Зарегистрируйся на CHILL, смотри следующие серии</a>
    </div>
...
{literal}
    <script>
                (function () {
                    ...
                    var HLS_OPEN_SRC_T = '{/literal}{$controller->get_preference('HLS_TEMPLATE_O',null)}{literal}';
