                                            ...
                                            <div class="chill-season-series-list-item" data-serie-id="{$serie->id}"  data-merge="2">
                                                <a href="#a_film_head_block" data-serie-id="{$serie->id}">
                                                    <div class="one_seria_select">
                                                        <img src="{$serie->image_url}.SW_300H_300CF_1PR_sq.jpg" />
                    ...
                    <div id="series_cadrs_a" class="owl-carousel">
                        ...
                        {foreach from=$this->frames item='frame'}
                            <div class="one_photo_frame" data-merge="2">
                                <a href="/media/media_content_frame/{$this->id}/{$frame->name}.SW_600.jpg" class="gooo" rel="gal">
...
<script>{literal}
    $(document).ready(function () {
        ...
        if (a < 6) {
            ...
            $("#balans_in").html('<a href="/Profile"><i class="mdi mdi-wallet-outline koshel"></i> <span id="balans_in_out_ser">' + bx + '</span> '+nx+'</a>')
        }
    });
    (function () {
        jQuery(function () {
            ...
            function player_play_end() {
                if (player.film_source) {
                    player.source = player.film_source;
                    player.film_source = null;
                    player.play();
                }
            }
