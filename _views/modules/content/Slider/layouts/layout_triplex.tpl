{if $this->images && $this->images->has_images}
    ...
    {$OUT->add_script("/assets/js/front/slider/slider.layout_triplex.js", 0, true)|void}
        ...
        {literal}
            (function () {
                ...
                window.Eve.SLIDER_CORE_READY.push(function () {
                    window.Eve.SLIDER_CORE(uuid, 'triplex', images,{/literal}{$this->timeout}{literal},{/literal}{$this->crop|intval}{literal},{/literal}{$this->crop_fill|intval}{literal}, '{/literal}{$this->background}{literal}',{/literal}{$this->properties->kvs|json_encode}{literal});
                });
            })();
        {/literal}
    </script>
