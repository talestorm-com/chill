<?php
/* Smarty version 3.1.33, created on 2020-10-24 14:03:55
  from '0a643423124800cebe4205f2872275428a12951e' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5f940a1b6b4013_35145377',
...
function content_5f940a1b6b4013_35145377 (Smarty_Internal_Template $_smarty_tpl) {
  ...
  $(document).ready(function() {
    ...
    $.getJSON(a)
      ...
      $.each(data.list.soap, function( i, item ) {
        ...
        var l = item.image;
        var n = item.name;
        $("#promo_films").append("<div class='one_promo_film' data-merge='2'><a href='/Soap/"+c+"'><img src='https://chillvision.ru/media/media_content_poster/"+c+"/"+l+".SW_400H_520CF_1.jpg'></a><h3><a href='/Soap/"+c+"'>"+n+"</a></h3></div>");
      });
