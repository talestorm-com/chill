<?php
/* Smarty version 3.1.33, created on 2020-10-24 13:59:49
  from 'ae32a9381a9b2913e20ed5a0af2c604b61a6c593' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5f940925cd62c9_15836611',
...
function content_5f940925cd62c9_15836611 (Smarty_Internal_Template $_smarty_tpl) {
  ...
  $(document).ready(function() {
    ...
    $.getJSON(a)
      ...
      $.each(data.list.soap, function( i, item ) {
        ...
        var l = item.image;
        var n = item.name;
$("#promo_films").append("<div class='one_promo_film'><a href='/Soap/"+c+"'><img src='https://chillvision.ru/media/media_content_poster/"+c+"/"+l+".SW_400H_520CF_1.jpg'></a><h3><a href='/Soap/"+c+"'>"+n+"</a></h3></div>");
      });
    });
  });
<?php echo '</script'; ?>
