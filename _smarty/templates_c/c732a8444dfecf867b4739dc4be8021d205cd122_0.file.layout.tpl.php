...
/* Smarty version 3.1.33, created on 2021-01-29 09:19:21
  from '/data/_layouts/front/layout.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_601370a9cbc614_70498084',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c732a8444dfecf867b4739dc4be8021d205cd122' => 
    array (
      0 => '/data/_layouts/front/layout.tpl',
      1 => 1611292662,
      2 => 'file',
    ),
  ),
...
function content_601370a9cbc614_70498084 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/data/lib/vendor/smarty/libs/plugins/function.eve_canonical.php','function'=>'smarty_function_eve_canonical',),1=>array('file'=>'/data/lib/vendor/smarty/libs/plugins/function.get_user_auth_status.php','function'=>'smarty_function_get_user_auth_status',),2=>array('file'=>'/data/lib/vendor/smarty/libs/plugins/function.display_user_money.php','function'=>'smarty_function_display_user_money',),3=>array('file'=>'/data/lib/vendor/smarty/libs/plugins/function.display_page_content.php','function'=>'smarty_function_display_page_content',),4=>array('file'=>'/data/lib/vendor/smarty/libs/plugins/function.TT.php','function'=>'smarty_function_TT',),5=>array('file'=>'/data/lib/vendor/smarty/libs/plugins/modifier.date_format.php','function'=>'smarty_modifier_date_format',),));
?>
<!DOCTYPE HTML>
...
>
    ...
    <?php if ($_smarty_tpl->tpl_vars['controller']->value->get_og_description()) {?>
    <meta name="description" content="Chill: <?php echo $_smarty_tpl->tpl_vars['controller']->value->get_og_description();?>
">
    <meta property="twitter:description" content="Chill: <?php echo $_smarty_tpl->tpl_vars['controller']->value->get_og_description();?>
">
    <?php } else { ?>
    ...
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['controller']->value->is_og_support()) {?>
    <?php if ($_smarty_tpl->tpl_vars['controller']->value->get_og_title() != '' && $_smarty_tpl->tpl_vars['controller']->value->get_og_title() != 'Chill') {?>
    <meta property="og:title" content="Chill. <?php echo $_smarty_tpl->tpl_vars['controller']->value->get_og_title();?>
">
    <meta property="twitter:title" content="Chill. <?php echo $_smarty_tpl->tpl_vars['controller']->value->get_og_title();?>
">
    <?php } else { ?>
    <meta property="og:title" content="Chill">
    <?php }?>
    <meta property="og:description" content="<?php echo $_smarty_tpl->tpl_vars['controller']->value->get_og_description();?>
">
    <meta property="og:url" content="<?php echo $_smarty_tpl->tpl_vars['controller']->value->get_og_url();?>
">
    <meta property="twitter:url" content="<?php echo $_smarty_tpl->tpl_vars['controller']->value->get_og_url();?>
">
    <?php } else { ?>
    <meta property="og:title" content="Chill">
    ...
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['controller']->value->is_og_image_support()) {?>
    <meta property="og:image" content="<?php echo $_smarty_tpl->tpl_vars['controller']->value->get_og_image_url();?>
">
    <meta property="twitter:image" content="<?php echo $_smarty_tpl->tpl_vars['controller']->value->get_og_image_url();?>
">
    <?php } else { ?>
    <meta property="og:image" content="https://chillvision.ru/assets/chill/images/logo_out.jpg?v=<?php echo time();?>
">
    <meta property="twitter:image" content="https://chillvision.ru/assets/chill/images/logo_out.jpg?v=<?php echo time();?>
">
    <?php }?>
...
" media="all" rel="stylesheet" type="text/css">
    ...
    <?php echo '<script'; ?>
 type="text/javascript" src="/assets/js/efo.js?a=1"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
...
>
    <?php echo '<script'; ?>
 type="text/javascript" src="/assets/chill/js/jquery.colorbox-min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 type="text/javascript" src="/assets/chill/js/main.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="https://yastatic.net/pcode/adfox/loader.js" crossorigin="anonymous"><?php echo '</script'; ?>
>
...
?>
    <?php $_smarty_tpl->_subTemplateRender('file:./cc.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
</head>

<body>
    <!-- <?php $_smarty_tpl->_subTemplateRender('file:./preload.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>-->
...
" />
    ...
    <div id="logaaa" style="display:none;"><?php echo smarty_function_get_user_auth_status(array(),$_smarty_tpl);?>
</div>
                    ...
                    <div class="one_footer_colomn">
                        ...
                        <div class="col l4 s11 offset-s1">
                            <div class="one_footer_colomn" id="last_column_footer">
                                <ul>
                                    <li>
                                        <i class="mdi-email mdi"></i><a
                                            href="mailto:help@chillvision.ru">help@chillvision.ru</a>
                                    </li>
                                    <li>
                ...
                <div class="col s12 m10 offset-m1">
                    <div class="row">
                        <div id="soc_footer">
                            ...
                            <a href="https://www.youtube.com/channel/UC8uFUbZc0ozz4DpDJlbfL-g?view_as=subscriber"
                                target="_blank">
...
?>-->
    <!--<?php $_smarty_tpl->_subTemplateRender('file:./mob_only.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>-->
    <?php $_smarty_tpl->_subTemplateRender('file:./prezpromo.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
