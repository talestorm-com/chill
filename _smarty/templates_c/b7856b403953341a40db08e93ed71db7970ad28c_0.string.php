<?php
/* Smarty version 3.1.33, created on 2020-11-13 09:13:25
  from 'b7856b403953341a40db08e93ed71db7970ad28c' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5fae240544f7c2_46459849',
...
function content_5fae240544f7c2_46459849 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="promo_page">
  <div id="top_barnding_gap"></div>
  <h1 id="main_header">В яблочко! Парни-лучники</h1>
  <p id="main_subheader">Яркая корейская комедия для тех, кто любит залипать в TikTok</p>
...
>
  ...
  $(document).ready(function() {
    var a = "https://chillvision.ru/Public/API?action=genre&id=10"
    var b = "https://chillvision.ru/Public/API?action=genre&id=10"
    $.getJSON(b)
      .done(function(data) {
