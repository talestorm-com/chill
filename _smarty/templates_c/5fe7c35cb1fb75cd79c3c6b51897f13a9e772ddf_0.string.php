<?php
/* Smarty version 3.1.33, created on 2020-11-13 17:20:40
  from '5fe7c35cb1fb75cd79c3c6b51897f13a9e772ddf' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5fae9638e47db7_56510378',
...
function content_5fae9638e47db7_56510378 (Smarty_Internal_Template $_smarty_tpl) {
...
<div class="promo_page">
  ...
  <div class="reg_button_line">
    <div id="reg_button">РЕГИСТРИРУЙСЯ – СМОТРИ КАЖДЫЙ ТРЕТИЙ СЕРИАЛ БЕСПЛАТНО!</div>
  </div>
...
>
  ...
  var aaa = '<div id="promo_page_video_bg_out"><div id="promo_page_video_bg"><a href="#">Зарегистрируйся на CHILL, <br>смотри следующие серии бесплатно.</a></div></div>';
  ...
  $(document).ready(function(){
    ...
    $("body").on('click', '#reg_button, #promo_page_video_bg', function(){

      dataLayer.push({
        'event': 'custom_event',
        'event_category': 'auth_pop-up', // 'reg_pop-up',
        'event_action': 'auth_pop-up_impression' // 'reg_pop-up_impression'
      });

      window.location.href = '/Soap/1215#login_open';
      return false;
    });
