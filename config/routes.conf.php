...
return [
    ...
    'routes' => [
      ...
      //  "/^\/{0,1}signup\/{0,1}$/i" => ['FrontEnd', 'Page', 'Index', ['alias' => 'signup']],
        ...
        "/^\/{0,1}Soap\/(?P<alias>\d{1,})$/i" => ["FrontEnd", "Page", "Index", ['alias' => 'soap_page', "soap_id" => '$$alias']],
        ...
        "/^\/{0,1}collection\/(?P<collection_id>\d{1,})$/i" => ["FrontEnd", "ChillCatalog", "Collection", [ "collection_id" => '$$collection_id']],        
