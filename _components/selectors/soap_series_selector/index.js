(function () {
    ...
    function initPlugin() {
        ...
        F.prototype.load = function (content_id) {
            this._content_id = U.IntMoreOr(content_id, 0, null);
            if (this._content_id) {
            ...
            return {
                ...
                columns: [
                    ...
                    {id:'named',key:'named',property:'named',text:'Наименование',columns:[
                            {id: "season_common_name", key: "season_common_name", property: "season_common_name", "text": "Сезон (яз ориг)", filter: "String", sort: true},
                            {id: "season_name", key: "season_name", property: "season_name", "text": "Сезон (тек яз)", filter: "String", sort: true},
                            {id: "series_common_name", key: "series_common_name", property: "series_common_name", "text": "Серия (яз.ориг)", filter: "String", sort: true},
                            {id: "series_name", key: "series_name", property: "series_name", "text": "Серия (тек яз)", filter: "String", sort: true}
                    ]},                                        
                    {id: "enabled", key: "enabled", property: "enabled", "text": "Вкл", filter: "Bool", sort: true},
                    {id: "season_enabled", key: "season_enabled", property: "season_enabled", "text": "Сез.Вкл.", filter: "Bool", sort: true}                    
                ]
            };
        };
        ...
        F.prototype.init_table = function () {
            ...
            var DSParams = ADVT.DataSource.SimplePostParams({'url': '/admin/MediaContent/API?action=list_soap_series', method: 'post'}, ADVT.DataSource.Extractor.MixExtractor({}));
        ...
        F.prototype.on_request_params = function (a, b, c) {
            if (this._content_id) {
                a.filters.soap_id = this._content_id;
            } else {
                b.process = false;
                b.error = "Отсутствует id родительского контента";
            }
            return this;
        };
