(function () {
    ...
    function initPlugin() {
            ...
            return {
                ...
                columns: [
                    ...
                    {id: 'named', key: 'named', property: 'named', text: 'Наименование', columns: [
                            {id: "season_common_name", key: "season_common_name", property: "season_common_name", "text": "яз ориг", filter: "String", sort: true},
                            {id: "season_name", key: "season_name", property: "season_name", "text": "тек яз", filter: "String", sort: true}
                        ]},
        ...
        F.prototype.init_table = function () {
            ...
            var DSParams = ADVT.DataSource.SimplePostParams({'url': '/admin/MediaContent/API?action=list_soap_seasons', method: 'post'}, ADVT.DataSource.Extractor.MixExtractor({}));
