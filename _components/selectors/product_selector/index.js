(function () {
    ...
    function initPlugin() {
        ...
        F.prototype.table_def = function () {
            return {
                ...
                columns: [
                    ...
                    {id: "enabled", key: "enabled", property: "enabled", "text": "Видим", filter: "Bool", sort: true},
                    {id: "guid", key: "guid", property: "guid", "text": "id 1c", filter: "String", sort: true}
        ...
        F.prototype.init_table = function () {
            ...
            var DSParams = ADVT.DataSource.SimplePostParams({'url': '/admin/Catalog/API?action=product_selector', method: 'post'}, ADVT.DataSource.Extractor.MixExtractor({}));
