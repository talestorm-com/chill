(function () {
    ...
    function initPlugin() {
        ...
        F.prototype.table_def = function () {
            return {
                ...
                columns: [
                    ...
                    {id: "address", key: "address", property: "address", "text": "Адрес", filter: "String", sort: true},
                    {id: "visible", key: "visible", property: "visible", "text": "активен", filter: "Bool", sort: true},
        ...
        F.prototype.init_table = function () {
            ...
            var DSParams = ADVT.DataSource.SimplePostParams({'url': '/admin/Storage/API?action=list_offline', method: 'post'}, ADVT.DataSource.Extractor.MixExtractor({}));
