(function () {
    ...
    function initPlugin() {
        ...
        F.prototype.table_def = function () {
            return {
                ...
                columns: [
                    ...
                    {id: "published", key: "published", property: "published", "text": "Опубликован", filter: "Bool", sort: true}                    
                ]
            };
        };
        ...
        F.prototype.init_table = function () {
            ...
            var DSParams = ADVT.DataSource.SimplePostParams({'url': '/admin/Pages/API?action=list', method: 'post'}, ADVT.DataSource.Extractor.MixExtractor({}));
