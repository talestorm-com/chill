(function () {
    ...
    function initPlugin() {
            ...
            return {
                ...
                columns: [
                    ...
                    {id:'named',key:'named',property:'named',text:'Наименование',columns:[
                            ...
                            {id: "trailer", key: "trailer", property: "trailer", "text": "Трейлер", filter: "String", sort: true}
                    ]},                                        
                    ...
                    {id: "soap_enabled", key: "soap_enabled", property: "soap_enabled", "text": "Сер.Вкл", filter: "Bool", sort: true}
                ]
            };
        };
        ...
        F.prototype.init_table = function () {
            ...
            var DSParams = ADVT.DataSource.SimplePostParams({'url': '/admin/MediaContent/API?action=list_soap_trailers', method: 'post'}, ADVT.DataSource.Extractor.MixExtractor({}));
