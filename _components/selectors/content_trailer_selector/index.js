(function () {
    ...
    function initPlugin() {
        ...
        F.prototype.load = function (content_id,loader_class_alias) {
            this._content_id = U.IntMoreOr(content_id, 0, null);
            this._loader_class_alias=U.NEString(loader_class_alias,null);
            if (this._content_id) {
        ...
        F.prototype.init_table = function () {
            ...
            var DSParams = ADVT.DataSource.SimplePostParams({'url': '/admin/MediaContent/API?action=list_content_trailers', method: 'post'}, ADVT.DataSource.Extractor.MixExtractor({}));
        ...
        F.prototype.on_request_params = function (a, b, c) {
            if (this._content_id) {
                a.filters.content_id = this._content_id;
                a.loader_class_alias = this._loader_class_alias;
            } else {                
                b.process = false;
