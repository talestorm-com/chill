(function () {
    ...
    function initPlugin() {
        ...
        F.prototype.getFooterButtons = function () {
            return [
                {'command': "add", 'text': "Добавить", buttonClass: MC + "_pull_left_crimson"},
                {'command': "cancel", 'text': "Отмена"},
                {'command': "save", 'text': "Выбрать"}
            ];
        };
        F.prototype.getDefaultTitle = function () {
            return "Выбор медиаперсоны";
        };
        //</editor-fold>                          
        ...
        F.prototype.table_def = function () {
            return {
                ...
                columns: [
                    ...
                    {id: "name", key: "name", property: "name", "text": "Имя / Псевдоним", filter: "String", sort: true}
        ...
        F.prototype.init_table = function () {
            ...
            var DSParams = ADVT.DataSource.SimplePostParams({'url': '/admin/MediaPerson/API?action=list', method: 'post'}, ADVT.DataSource.Extractor.MixExtractor({}));
...
//            this.getRole('catalog_filter').val(U.NEString(o.n, null));
        ...
        F.prototype.run_editor = function () {
            this.showLoader();
            Y.load('data_editor.media_person')
                    .done(this, this.editor_ready)
        ...
        F.prototype.editor_ready = function (x) {
