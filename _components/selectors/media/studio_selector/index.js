(function () {
    ...
    function initPlugin() {
        ...
        F.prototype.table_def = function () {
            return {
                ...
                columns: [
                    ...
                    {id: "common_name", key: "common_name", property: "common_name", "text": "Родное наименование", filter: "String", sort: true},
                    {id: "name", key: "name", property: "name", "text": "Наименование на тек. языке", filter: "String", sort: true}  
        ...
        F.prototype.init_table = function () {
            ...
            var DSParams = ADVT.DataSource.SimplePostParams({'url': '/admin/VendorList/API?action=list', method: 'post'}, ADVT.DataSource.Extractor.MixExtractor({}));
...
//            this.getRole('catalog_filter').val(U.NEString(o.n, null));
        ...
        F.prototype.run_editor = function(){
            this.showLoader();
            Y.load('data_editor.media_vendor')
        ...
        F.prototype.on_editor_ready = function (x) {
            x.show().load(this._id_to_edit).setCallback(this, this.load);
            return this;
        };
