(function () {
    ...
    function initPlugin() {
        ...
        F.prototype.getDefaultTitle = function () {
            return "Выбор возрастного ограничения";
        };
        //</editor-fold>                          
        ...
        F.prototype.table_def = function () {
            return {
                ...
                columns: [
                    ...
                    {id: "international_name", key: "international_name", property: "international_name", "text": "Наименование международное", filter: "String", sort: true},
        ...
        F.prototype.init_table = function () {
            ...
            var DSParams = ADVT.DataSource.SimplePostParams({'url': '/admin/AgeRestrictionList/API?action=list', method: 'post'}, ADVT.DataSource.Extractor.MixExtractor({}));
...
//            this.getRole('catalog_filter').val(U.NEString(o.n, null));
        ...
        F.prototype.onCommandAdd = function () {
            this.showLoader();
            Y.load('data_editor.age_restriction')
