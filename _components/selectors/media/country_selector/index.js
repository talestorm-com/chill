(function () {
    ...
    function initPlugin() {
        ...
        F.prototype.table_def = function () {
            return {
                ...
                columns: [
                    ...
                    {id: "name", key: "name", property: "name", "text": "Наименование", filter: false, sort: false, columns: [
                            {id: "common_name", key: "common_name", property: "common_name", "text": "Родное", filter: "String", sort: true},
                            {id: "name", key: "name", property: "name", "text": "На тек. языке", filter: "String", sort: true}
                        ]}
                    //,{id: "comment", key: "comment", property: "comment", "text": "Описание", filter: "String", sort: true}                                      
                ]
            };
        };
        ...
        F.prototype.init_table = function () {
            ...
            var DSParams = ADVT.DataSource.SimplePostParams({'url': '/admin/CountryList/API?action=list', method: 'post'}, ADVT.DataSource.Extractor.MixExtractor({}));
