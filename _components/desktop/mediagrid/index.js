(function () {
    ...
    var imports = [// стиль встроен в компонент      
        ...
        Y.js('/assets/js/TypeVoc/MediaTypeVoc.js')
                , Y.load('inline.inline_media_grid').promise
    ];
    //</editor-fold>
    function initPlugin() {
    ...
    function initPluginA() {
        ...
        F.prototype.onInit = function () {
            ...
            this.splitter = EFO.Widgets.Splitter()
                    .setController(this)
                    .setElements(this.getRole('grid'), this.getRole('table'))
...
//        };
        ...
        F.prototype.init_dnd = function () {
            EFO.DnDManager().LEM.on('ON_DRAG_STARTS_ctSEASON', this, this.on_drag_starts);
        };
        ...
        F.prototype.table_def = function () {
            return {
                ...
                columns: [
                    ...
                    , {id: "grid", key: "grid", property: "grid", "text": "Сетка", filter: false, sort: false}
        ...
        F.prototype.init_table = function () {
            ...
            this.table.addRenderer('display_grid_value', (function () {                
                var t = U.IntMoreOr(this.grid, -1, -1);
                return t >= 0 ? t + 1 : '';
            }));
            ...
            var DSParams = ADVT.DataSource.SimplePostParams({'url': '/admin/MediaGrid/API?action=list', method: 'post'}, ADVT.DataSource.Extractor.MixExtractor({}));
...
//            }
        ...
        F.prototype.init_lent = function () {
            debugger;
            var lf = Y.get_loaded_component('inline.inline_media_grid');
            this.lent = lf();
            this.lent.setContainer(this.getRole('grid_content'));
            return this;
        };
        ...
        F.prototype.onCommandReload_grid = function () {
            this.lent.save_data(this.reload.bindToObject(this));
            return this;
        };
        //</editor-fold>                        
