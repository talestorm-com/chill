(function () {
    ...
    function initPlugin() {
        ...
        F.prototype.table_def = function () {
            return {
                ...
                columns: [
                    ...
                    {id: "phone", key: "phone", property: "phone", "text": "Телефон", filter: false, sort: false},
                    {id: "address", key: "address", property: "address", "text": "Адрес", filter: "String", sort: false},                                              
        ...
        F.prototype.init_table = function () {
            ...
            this.table.addRenderer('render_address', function () {
                var s = U.NEString(this.address,'');
                var r = s.substr(0,150);
                if(s!==r){
                    r+="..";
                }
                return r;
            ...
            var DSParams = ADVT.DataSource.SimplePostParams({'url': '/admin/TrainingHall/API?action=list', method: 'post'}, ADVT.DataSource.Extractor.MixExtractor({}));
        ...
        F.prototype.load_editor = function () {
            this.showLoader();
            Y.load('data_editor.training_hall')
        ...
        F.prototype.onCommandRemove = function (t) {
            ...
            EFO.simple_confirm()
                    ...
                    .set_text("Удалить этот зал?")
                    .set_callback(this, function (confirm, index) {
                        if (U.IntMoreOr(index, 0, 0) === 2) {
                            this.table.reloadFromUrl("/admin/TrainingHall/API?action=remove&id_to_remove=" + id);
                        }
                    })
                    .set_style("blue")
                    .set_icon("baloon?")
