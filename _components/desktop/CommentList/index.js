    ...
    function initPlugin() {
        ...
        F.prototype.table_def = function () {
            return {
                ...
                columns: [
                    {id: "id", key: "id", property: "id", "text": "ID", filter: "String", sort: true},
                    {id: "datum", key: "datum", property: "datum", "text": "Дата", filter: "Date", sort: true},
                    {id: "author", key: "author", property: "author", "text": "Автор", filter: "String", sort: true},
                    {id: "enabled", key: "enabled", property: "enabled", "text": "Вкл", filter: "Bool", sort: true},
                    {id: "rating", key: "rating", property: "rating", "text": "Рейтинг", filter: "Int", sort: true},
                    {id: "content", key: "content", property: "content", "text": "content", filter: false, sort: false},
                    {id: "sticker", key: "sticker", property: "sticker", "text": "sticker", filter: false, sort: false},
                    {id: "r", key: "r", property: "r", "text": "Resp", filter: false, sort: false},
        ...
        F.prototype.init_table = function () {
            ...
            this.table.addRenderer('has_sticker',function(){
                return U.NEString(this.cdn_url,null)?true:false;
            });

            var DSParams = ADVT.DataSource.SimplePostParams({'url': '/admin/ChillComment/API?action=list', method: 'post'}, ADVT.DataSource.Extractor.MixExtractor({}));
        ...
        F.prototype.load_editor = function () {
            this.showLoader();
            Y.load('data_editor.chill_comment_editor')
                ...
                EFO.simple_confirm()
                        ...
                        .set_callback(this, function (confirm, index) {
                            if (U.IntMoreOr(index, 0, 0) === 2) {
                                this.table.reloadFromUrl("/admin/ChillComment/API?action=remove&id_to_remove=" + id);
                            }
                        })
                        .set_style("blue")
                        .set_icon("baloon?")
