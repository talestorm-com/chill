...
//            "employer": "Сотрудник",
        ...
        F.prototype.table_def = function () {
            return {
                ...
                columns: [
                    ...
                    {id: "name", key: "name", property: "name", "text": "Пользователь", filter: "String", sort: true},
                    {id: "login", key: "login", property: "login", "text": "Email / логин", filter: "String", sort: true},
                    {id: "phone", key: "phone", property: "phone", "text": "Телефон", filter: "String", sort: true},
                    {id: "locked", key: "locked", property: "locked", "text": "Блок", filter: "Boolean", sort: true},
                    {id: "role", key: "role", property: "role", text: "Роль", filter: "String", sort: true},
                    //{id: "approved", key: "approved", property: "approved", text: "Подтв", sort: true, filter: "Boolean"},
                    //{id: "news", key: "news", property: "news", text: "Расс.", sort: true, filter: "Boolean"},
                    {id: "created", key: "created", property: "created", text: "Создан", sort: true, filter: "Date"},
                    {id: "birth_date", key: "birth_date", property: "birth_date", text: "Дата рождения", sort: true, filter: "Date"},
                    {id: "money", key: "money", property: "money", "text": "Баланс", filter: "Int", sort: true},
        ...
        F.prototype.init_table = function () {
            ...
            this.table.addRenderer('format_phone', function () {
                return EFO.Checks.formatPhone(this.phone);
            });
            this.table.addRenderer('translate_role', function () {
                return U.NEString(role_trans[this.role], this.role);
            });
             this.table.addRenderer('render_money', function () {
                return  EFO.Checks.formatPriceNSD( U.FloatOr(this.money,0),2);
            });
            var DSParams = ADVT.DataSource.SimplePostParams({'url': '/admin/Users/API?action=get_data', method: 'post'}, ADVT.DataSource.Extractor.MixExtractor({}));
        ...
        F.prototype.onCommandUser_add = function () {
            this._user_to_edit = null;
            return this.load_editor();
        };

        F.prototype.onCommandEdit_user = function (t) {
            var id = U.IntMoreOr(t.data('id'), 0, null);
            if (id) {
                this._user_to_edit = id;
                this.load_editor();
            }
            return this;
        };
        ...
        F.prototype.on_editor_ready = function (x) {
            return x.show().load(this._user_to_edit).setCallback(this, this.reload);
            return this;
        };
        ...
        F.prototype.onCommandRemove = function (t) {
            ...
            EFO.simple_confirm()
                    ...
                    .set_text("Удалить этого пользователя?<br>Это удалит все его публикации, покупки и файлы!<br><b style=\"color:crimson;font-size:.9em\">Восстановить удаленное будет невозможно!<b>")
                    .set_callback(this, function (confirm, index) {
                        if (U.IntMoreOr(index, 0, 0) === 2) {
                            this.table.reloadFromUrl("/admin/Users/API?action=remove&id_to_remove=" + user_id);
                        }
                    })
                    .set_style("blue")
                    .set_icon("baloon?")
