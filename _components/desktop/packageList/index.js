(function () {
    ...
    function initPlugin() {
        ...
        F.prototype.table_def = function () {
            return {
                ...
                columns: [
                    ...
                    {id: "price", key: "price", property: "price", "text": "Ценник", filter: "Numeric", sort: true},
                    {id: "days", key: "days", property: "days", "text": "Срок", filter: "Int", sort: true},
                    {id: "usages", key: "usages", property: "usages", "text": "Лимит", filter: "Int", sort: true},
        ...
        F.prototype.init_table = function () {
            ...
            var DSParams = ADVT.DataSource.SimplePostParams({'url': '/admin/Package/API?action=list', method: 'post'}, ADVT.DataSource.Extractor.MixExtractor({}));
        ...
        F.prototype.load_editor = function () {
            this.showLoader();
            Y.load('data_editor.package_item')
        ...
        F.prototype.onCommandRemove = function (t) {
            ...
            EFO.simple_confirm()
                    ...
                    .set_text("Удалить этот пакет?")
                    .set_callback(this, function (confirm, index) {
                        if (U.IntMoreOr(index, 0, 0) === 2) {
                            this.table.reloadFromUrl("/admin/Package/API?action=remove&id_to_remove=" + id);
                        }
                    })
                    .set_style("blue")
                    .set_icon("baloon?")
