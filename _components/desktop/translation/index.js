    ...
    function initPlugin() {
        ...
        F.prototype.table_def = function () {
            return {
                ...
                columns: [
                    {id: "section", key: "section", property: "section", "text": "Секция", filter: "String", sort: true},
                    {id: "token", key: "token", property: "token", "text": "Терм", filter: "String", sort: true},
        ...
        F.prototype.init_table = function () {
            ...
            var DSParams = ADVT.DataSource.SimplePostParams({'url': '/admin/T/API?action=list', method: 'post'}, ADVT.DataSource.Extractor.MixExtractor({}));
        ...
        F.prototype.onCommandRemove = function (t) {
            ...
            if (id && section) {
                this.table.reloadFromUrl("/admin/T/API?action=remove&remove_section="+encodeURIComponent(section)+"&remove_id="+encodeURIComponent(id));                
            }
            return this;
        };
        ...
        F.prototype.onMonitorChange = function (t) {
            ...
            if (id) {
                ...
                if (section) {
                    var v = t.val();
                    var self = this;
                    jQuery.getJSON("/admin/T/API", {action: "set", name: id, value: v, section: section})
                            .done(function (d) {
                                if (U.isObject(d)) {
                                    if (d.status === 'ok') {
