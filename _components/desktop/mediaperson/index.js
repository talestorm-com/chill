    ...
    function initPlugin() {
        ...
        F.prototype.table_def = function () {
            return {
                ...
                columns: [
                    ...
                    {id:"name_common",key:"name_common",text:"Имя / псевдоним",columns:[
                            {id: "name_en", key: "name_en", property: "name_en", "text": "Род.Яз.", filter: "String", sort: true},                    
                            {id: "name", key: "name", property: "name", "text": "Тек.Яз.", filter: "String", sort: true}
                    ]},                    
        ...
        F.prototype.onCommandRemove = function (t) {
            ...
            EFO.simple_confirm()
                    ...
                    .set_text("Удалить эту личность?")
                    .set_callback(this, function (confirm, index) {
                        if (U.IntMoreOr(index, 0, 0) === 2) {
                            this.table.reloadFromUrl("/admin/MediaPerson/API?action=remove&id_to_remove=" + id);
                        }
                    })
                    .set_style("blue")
                    .set_icon("baloon?")
