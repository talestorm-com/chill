        ...
        F.prototype.table_def = function () {
            return {
                ...
                columns: [
                    ...
                    {id: "common_name", key: "common_name", property: "common_name", "text": "Оригинальное название", filter: "String", sort: true},
                    {id: "name", key: "name", property: "name", "text": "Название на русском", filter: "String", sort: true},
        ...
        F.prototype.onCommandRemove = function (t) {
            ...
            if (id) {
                EFO.simple_confirm()
                        ...
                        .set_text("Удалить этот студию?<br><b style=\"color:crimson;font-size:.9em\">Это действие нельзя отменить<b>")
                        .set_callback(this, function (confirm, index) {
                            if (U.IntMoreOr(index, 0, 0) === 2) {
                                this.table.reloadFromUrl("/admin/VendorList/API?action=remove&id_to_remove=" + id);
                            }
                        })
                        .set_style("blue")
                        .set_icon("baloon?")
