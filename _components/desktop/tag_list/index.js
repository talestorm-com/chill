        ...
        F.prototype.onCommandRemove = function (t) {
            ...
            if (id) {
                EFO.simple_confirm()
                        ...
                        .set_text("Удалить этот тег?<br><b style=\"color:crimson;font-size:.9em\">Это действие нельзя отменить<b>")
                        .set_callback(this, function (confirm, index) {
                            if (U.IntMoreOr(index, 0, 0) === 2) {
                                this.table.reloadFromUrl("/admin/TagList/API?action=remove&id_to_remove=" + id);
                            }
                        })
                        .set_style("blue")
                        .set_icon("baloon?")
