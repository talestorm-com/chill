    ...
    function initPlugin() {
        ...
        F.prototype.table_def = function () {
            return {
                ...
                columns: [
                    ...
                    {id: "description", key: "description", property: "description", "text": "Инфо", filter: "String", sort: true},
        ...
        F.prototype.init_table = function () {
            ...
            this.table.addRenderer('description_subtext', function () {
                var st = U.NEString(U.NEString(this.description, '').substr(0, 50), '');
                if (st !== this.description) {
                    st += "...";
                }
                return st;
            });
            var DSParams = ADVT.DataSource.SimplePostParams({'url': '/admin/Navigation/API?action=get_data', method: 'post'}, ADVT.DataSource.Extractor.MixExtractor({}));
        ...
        F.prototype.onCommandMenu_add = function () {
            this._menu_to_edit = null;
            return this.load_editor();
        };

        F.prototype.onCommandEdit_menu = function (t) {
            var id = U.IntMoreOr(t.data('id'), 0, null);
            if (id) {
                this._menu_to_edit = id;
                this.load_editor();
            }
            return this;
        };
        ...
        F.prototype.on_editor_ready = function (x) {
            return x.show().load(this._menu_to_edit).setCallback(this, this.reload);
            return this;
        };
        ...
        F.prototype.onCommandRemove = function (t) {
            ...
            EFO.simple_confirm()
                    ...
                    .set_text("Удалить это меню?<br><b style=\"color:gray;font-size:.9em\">Это действие не затронет контент - только само меню<b>")
                    .set_callback(this, function (confirm, index) {
                        if (U.IntMoreOr(index, 0, 0) === 2) {
                            this.table.reloadFromUrl("/admin/Navigation/API?action=remove&id_to_remove=" + user_id);
                        }
                    })
                    .set_style("blue")
                    .set_icon("baloon?")
