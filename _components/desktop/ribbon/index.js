(function () {
    ...
    function initPlugin() {
        ...
        F.prototype.table_def = function () {
            return {
                ...
                columns: [
                    ...
                    {id: "target", key: "target", property: "traget", "text": "Цель", filter: "String", sort: true},
                    {id: "image", key: "image", property: "image", "text": "image", filter: false, sort: false},
                    {id: "title", key: "title", property: "title", "text": "Заголовок", filter: "String", sort: true},
                    ...
                    {id: "note", key: "note", property: "note", "text": "note", filter: false, sort: false},
        ...
        F.prototype.init_table = function () {
            ...
            this.table.addRenderer('render_note', function () {
                var t = U.NEString(this.link_type, null);
                if (t) {
                    var typename = U.NEString(NAMES[t], t);
                    var item_info = U.NEString(this.link_id, U.NEString(this.link_uid, null));
                    return [typename, item_info].join('#');
                }
                return '';
            });
            this.table.addRenderer('render_image', function () {
                if (U.NEString(this.image_context, null) && U.NEString(this.image_owner_id, null) && U.NEString(this.image, null)) {
                    return ["/media/", this.image_context, "/", this.image_owner_id, "/", this.image, '.SW_200H_200.jpg?a=tf', (new Date()).getTime()].join('');
                }
                return 'javascript:void(0);';
            });
            this.table.addRenderer('image_exists', function () {
                if (U.NEString(this.image_context, null) && U.NEString(this.image_owner_id, null) && U.NEString(this.image, null)) {
                    return true;
                }
                return false;
            });
            this.table.addRenderer('render_target', function () {
                if (this.target === '*') {
                    return "Всем";
                }
                return this.target;
            ...
            var DSParams = ADVT.DataSource.SimplePostParams({'url': '/admin/Ribbon/API?action=list', method: 'post'}, ADVT.DataSource.Extractor.MixExtractor({}));
        ...
        F.prototype.load_editor = function () {
            this.showLoader();
            Y.load('data_editor.ribbon_item')
        ...
        F.prototype.onCommandRemove = function (t) {
            ...
            EFO.simple_confirm()
                    ...
                    .set_text("Удалить это событие?<br>")
                    .set_callback(this, function (confirm, index) {
                        if (U.IntMoreOr(index, 0, 0) === 2) {
                            this.table.reloadFromUrl("/admin/Ribbon/API?action=remove&id_to_remove=" + id);
                        }
                    })
                    .set_style("blue")
                    .set_icon("baloon?")
