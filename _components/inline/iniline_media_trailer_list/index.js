(function () {
    ...
    function initPlugin() {
        ...
        F.prototype.ci_get_id = function () {
            if (this.CI) {
                try {
                    return this.CI.trailer_list_get_id();
                } catch (e) {
        ...
        F.prototype.ci_get_path = function () {
            if (this.CI) {
                try {
                    return this.CI.trailer_list_get_path();
                } catch (e) {
        ...
        F.prototype.ci_get_pathbuilder = function () {
            if (this.CI) {
                try {
                    return this.CI.trailer_list_get_pathbuilder();
                } catch (e) {
        ...
        F.prototype.init_table = function () {
            ...
            var DSParams = ADVT.DataSource.SimplePostParams({'url': '/admin/MediaContent/API?action=list_trailers', method: 'post'}, ADVT.DataSource.Extractor.MixExtractor({}));
        ...
        F.prototype.on_request_params = function (a, b, c) {
            ...
            if (id) {
                a.filters.content_id = id;
                return this;
            }
            b.process = false;
            b.error = "Сначала нужно сохранить основной контент";
            return this;
        };
        ...
        F.prototype.onCommandAdd_trailer = function () {
            var id = this.ci_get_id();
            if (!id) {
                U.TError("Сначала необходимо сохранить основной контент!");
                return this;
            }
        ...
        F.prototype.onCommandEdit_trailer = function (t) {
            var id = this.ci_get_id();
            if (!id) {
                U.TError("Сначала необходимо сохранить основной контент!");
                return this;
        ...
        F.prototype.load_editor = function () {
            this.showLoader();
            Y.load('data_editor.media_trailer')
        ...
        F.prototype.on_editor_ready = function (x) {            
            ...
            if (pathbuilder) {
                x.show().load(this._id_to_edit, this.ci_get_id(), pathbuilder.by_appending('trailers').set_private(false)).setCallback(this, this.on_trailer_editor_done);
            }
            return this;
        };
        F.prototype.on_trailer_editor_done = function () {
            this.reload();
        };
        ...
        F.prototype.onCommandRemove = function (t) {
            ...
            if (id) {
                EFO.simple_confirm()
                        ...
                        .set_text("Удалить этот трейлер и <b>все связанные файлы</b>?")
                        .set_callback(this, function (confirm, index) {
                            if (U.IntMoreOr(index, 0, 0) === 2) {
                                this.table.reloadFromUrl("/admin/MediaContent/API?action=remove_trailer&id_to_remove=" + id);
                            }
                        })
                        .set_style("blue")
                        .set_icon("baloon?")
