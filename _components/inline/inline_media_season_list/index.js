(function () {
    ...
    function initPlugin() {
        ...
        F.prototype.ci_get_id = function () {
            if (this.CI) {
                try {
                    return this.CI.season_list_get_id();
                } catch (e) {
        ...
        F.prototype.ci_get_path = function () {
            if (this.CI) {
                try {
                    return this.CI.season_list_get_path();
                } catch (e) {
        ...
        F.prototype.ci_get_pathbuilder = function () {
            if (this.CI) {
                try {
                    return this.CI.season_list_get_pathbuilder();
                } catch (e) {
        ...
        F.prototype.get_table_def = function () {
            return {
                ...
                columns: [
                    ...
                    {id: "num", key: "num", property: "num", "text": "№№ сезона", filter: "Int", sort: true},
                    ...
                    {id: "series", key: "series", property: "series", "text": "К-во серий", filter: false, sort: false},
        ...
        F.prototype.init_table = function () {
            ...
            var DSParams = ADVT.DataSource.SimplePostParams({'url': '/admin/MediaContent/API?action=list_season_seasons', method: 'post'}, ADVT.DataSource.Extractor.MixExtractor({}));
        ...
        F.prototype.onCommandEdit_season_season = function (t) {
            var id = this.ci_get_id();
            if (!id) {
                U.TError("Сначала необходимо сохранить основной контент!");
                return this;
        ...
        F.prototype.load_editor = function () {
            this.showLoader();
            Y.load('data_editor.mediacontent.type_editor.season_season_editor')
        ...
        F.prototype.onCommandRemove = function (t) {
            ...
            if (id) {
                EFO.simple_confirm()
                        ...
                        .set_text("Удалить этот сезон и <b>все связанные файлы</b><br>и <b>все серии</b>?")
                        .set_callback(this, function (confirm, index) {
                            if (U.IntMoreOr(index, 0, 0) === 2) {
                                this.table.reloadFromUrl("/admin/MediaContent/API?action=remove_season_season&id_to_remove=" + id);
                            }
                        })
                        .set_style("blue")
                        .set_icon("baloon?")
