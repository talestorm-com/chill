(function () {
    ...
    function initPlugin() {
        ...
        F.prototype.getDefaultTitle = function () {
            return "Редактирование инфостраницы";
        };
        //</editor-fold>                          
        ...
        F.prototype.load = function (id) {
            ...
            if (U.IntMoreOr(id, 0, null)) {
                this.showLoader();
                jQuery.getJSON('/admin/Pages/API', {action: "get", id: id})
        ...
        F.prototype.on_load_responce = function (d) {
            if (U.isObject(d)) {
                if (d.status === "ok") {
                    return this.on_data_success(d.infopage);
                }
                if (d.status === 'error') {
        ...
        F.prototype.init_image_list = function () {
            ...
            this.image_list.set_params('infopage_gallery', null);
            return this;
        };
        ...
        F.prototype._set_field_content = function (a) {
            this.editor.setText(U.NEString(a.content, ''), U.anyBool(a.html_mode_c, true));
            return this;
        };
        ...
        F.prototype._get_field_content = function () {
            return this.editor.getText();
        };

        F.prototype._set_field_intro = function (a) {
            this.intro_editor.setText(U.NEString(a.intro, ''), U.anyBool(a.html_mode_i, true));
            return this;
        };
        F.prototype._set_field_html_mode_i = function () {
            return this;
        };
        F.prototype._get_field_html_mode_i = function () {
        ...
        F.prototype.save = function (keep_open) {
            ...
            this.showLoader();
            jQuery.post('/admin/Pages/API', post_data, null, 'json')
        ...
        F.prototype.on_post_responce = function (d) {
            if (U.isObject(d)) {
                if (d.status === "ok") {
                    this.on_data_success(U.safeObject(d.infopage));
                    this.runCallback();
                    if (!this._keep_open) {
                        this.hide().clear();
                    }
