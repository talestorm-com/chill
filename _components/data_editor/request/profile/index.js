(function () {
    ...
    function initPlugin() {
        ...
        F.prototype.getDefaultTitle = function () {
            return "Редактирование вида деятельности";
        };
        //</editor-fold>                          
        ...
        F.prototype.load = function (id) {
            ...
            if (U.IntMoreOr(id, 0, null)) {
                this.showLoader();
                jQuery.getJSON('/admin/Profiles/API', {action: "get", id: id})
        ...
        F.prototype.onMonitorInt = function (t) {
            var v = U.IntOr(t.val(), null);
            t.val(v !== null ? v : '');
            return this;
        };    
        //</editor-fold>
        ...
        F.prototype.save = function (keep_open) {
            ...
            this.showLoader();
            jQuery.post('/admin/Profiles/API', post_data, null, 'json')
