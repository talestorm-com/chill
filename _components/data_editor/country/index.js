    ...
    function initPlugin() {
        ...
        F.prototype.load = function (id) {
            ...
            if (U.IntMoreOr(id, 0, null)) {
                this.showLoader();
                jQuery.getJSON('/admin/CountryList/API', {action: "get", id: id})
                ...
                this.showLoader();
                jQuery.getJSON('/admin/CountryList/API', {action: "langlist"})
        ...
        F.prototype.save = function (keep_open) {
            ...
            jQuery.post('/admin/CountryList/API', post_data, null, 'json')
