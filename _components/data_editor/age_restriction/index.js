(function () {
    ...
    function initPlugin() {
        ...
        F.prototype.init_image_list = function () {
            ...
            this.image_list.set_params('age_restriction', null);
            return this;
        };
        ...
        F.prototype.getDefaultTitle = function () {
            return "Редактирование возрастного ограничения";
        };
        //</editor-fold>                          
        ...
        F.prototype.load = function (id) {
            ...
            if (U.IntMoreOr(id, 0, null)) {
                this.showLoader();
                jQuery.getJSON('/admin/AgeRestrictionList/API', {action: "get", id: id})
                ...
                this.showLoader();
                jQuery.getJSON('/admin/AgeRestrictionList/API', {action: "langlist"})
        ...
        F.prototype.clear = function () {
            ...
            this.clearCallbacks();
            this.image_list ? this.image_list.set_owner_id(null) : 0;
        ...
        F.prototype.save = function (keep_open) {
            ...
            jQuery.post('/admin/AgeRestrictionList/API', post_data, null, 'json')
