(function () {
    ...
    function initPlugin() {
        ...
        F.prototype.load = function (media_id,user_id) {
            this.clear();
            if (U.IntMoreOr(media_id, 0, null) && U.IntMoreOr(user_id, 0, null)) {
                this.showLoader();
                jQuery.getJSON('/admin/Reviews/API', {action: "get", media_id: media_id,user_id:user_id})
        ...
        F.prototype.save = function (keep_open) {
            ...
            jQuery.post('/admin/Reviews/API', post_data, null, 'json')
