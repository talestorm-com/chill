    ...
    function initPlugin() {
        ...
        F.prototype.load = function (id) {
            ...
            if (U.IntMoreOr(id, 0, null)) {
                this.showLoader();
                jQuery.getJSON('/admin/Sticker/API', {action: "get", id: id})
        ...
        //</editor-fold>
        F.prototype._set_field_preview = function (d, fi) {
            if (U.NEString(d.cdn_url, null)) {
                fi.attr('src', "//" + d.cdn_url);
            } else {
                fi.attr('src', '');
            }
            return this;
        };
        F.prototype._get_field_preview = function(){
            return null;
        };
        ...
        F.prototype.save = function (keep_open) {
            ...
            this.showLoader();
            jQuery.post('/admin/Sticker/API', post_data, null, 'json')
        ...
        F.prototype.file_manager_ready = function (x) {
            var pathbuilder = window.Eve.PathBuilder('stickers', U.IntMoreOr(this.getField('id').val(), 0, null));
            pathbuilder.set_private(false);
            pathbuilder.setAccept('*/*');
