(function () {
    ...
    function initPlugin() {
        ...
        F.prototype.getFooterButtons = function () {
            return [
                {'command': "regen", 'text': "fix tables", buttonClass: MC + "crimson " + MC + "pullleft"},
        ...
        F.prototype.load = function (id) {
            debugger;
            this.clear();
            if (U.NEString(id, null)) {
                this.showLoader();
                jQuery.getJSON('/admin/LanguageList/API', {action: "get", id: id})
        ...
        F.prototype.onMonitorId = function (t) {
            t.val(U.NEString(t.val(), '').toLowerCase());
            return this;
        };
        F.prototype.onMonitorName = function (t) {
            t.val(U.NEString(t.val(), ''));
            return this;
        };
        //</editor-fold>
        ...
        F.prototype.onCommandRegen = function () {
            debugger;
            var id = U.NEString(this.getField('id').val(), null);
            if (id) {
                this.showLoader();
                jQuery.getJSON('/admin/LanguageList/API', {action: "fix", id: id})
                        .always(this.hideLoader.bindToObject(this));
            }
            return this;
        };
        ...
        F.prototype.save = function (keep_open) {
            ...
            this.showLoader();
            jQuery.post('/admin/LanguageList/API', post_data, null, 'json')
