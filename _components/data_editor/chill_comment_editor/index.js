    ...
    function initPlugin() {
        ...
        F.prototype.load = function (id) {
            ...
            if (U.IntMoreOr(id, 0, null)) {
                this.showLoader();
                jQuery.getJSON('/admin/ChillComment/API', {action: "get", id: id})
        ...
        //</editor-fold>                               
        F.prototype._set_field_sticker_url = function (d, fi) {
            if (U.NEString(d.sticker_url, null)) {
                fi.attr('src', "//" + d.sticker_url);
            } else {
                fi.attr('src', '');
            }
            return this;
        };
        F.prototype._get_field_sticker_url = function () {
            return null;
        };
        ...
        F.prototype.save = function (keep_open) {
            ...
            this.showLoader();
            jQuery.post('/admin/ChillComment/API', post_data, null, 'json')
        ...
        F.prototype.onCommandSelect_sticker = function () {
            this.showLoader();
            Y.load('selectors.sticker_selector').done(this, this.selector_ready)
        ...
        F.prototype.selector_ready = function (x) {
            x.set_allow_multi(false).show().setCallback(this, this.on_selected);
            return;
        };

        F.prototype.on_selected = function (x) {
            x = U.safeArray(x);
            if (x.length) {
                this.getField('sticker').val(U.IntMoreOr(x[0].id, 0, null));
                this.getField('sticker_name').val(U.NEString(x[0].name, null));
                this.getField('sticker_url').attr('src', "//"+U.NEString(x[0].cdn_url, null));
            }
            return this;
        };
