    ...
    function initPlugin() {
        ...
        F.prototype.load = function (id) {
            ...
            if (U.IntMoreOr(id, 0, null)) {
                this.showLoader();
                jQuery.getJSON('/admin/Storage/API', {action: "get_partner", id: id})
        ...
        F.prototype.on_load_responce = function (d) {
            if (U.isObject(d)) {
                if (d.status === "ok") {
                    return this.on_data_success(d.partner);
                }
                if (d.status === 'error') {
        ...
        F.prototype.on_post_responce = function (d) {
            if (U.isObject(d)) {
                if (d.status === "ok") {
                    this.on_data_success(U.safeObject(d.partner));
                    this.runCallback();
                    if (!this._keep_open) {
                        this.hide().clear();
                    }
