(function () {
    ...
    function initPlugin() {
        ...
        F.prototype.onCommandLogin = function () {
            try {
            ...
            this.showLoader();
            df.action="auth";
            jQuery.post('/admin/AdminAuth/API', df, null, 'json')
        ...
        F.prototype.onErrorLOCK_USER_ROOT = function (d) {
            this.showLoader();
            this._root = true;
        ...
        F.prototype.onErrorLOCK_USER_CHILD = function (d) {
            this.showLoader();
            this._root = false;
            jQuery.componentor().LoadComponent('CommonForms.LockedLoginDialog.LockedLoginDialog')
                    .done(this.onLockReady.bindToObject(this))
        ...
        F.prototype.onCommandRestore = function () {
            ...
            df.password = null;
            this.showLoader();
            jQuery.getJSON('/login/reset_s1', df)
