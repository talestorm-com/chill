...
<head>
    ...
    {if $controller->get_og_description()}
    <meta name="description" content="Chill: {$controller->get_og_description()}">
    <meta property="twitter:description" content="Chill: {$controller->get_og_description()}">
    {else}
    ...
    {if $controller->get_og_title() != '' && $controller->get_og_title() != 'Chill'}
    <meta property="og:title" content="Chill. {$controller->get_og_title()}">
    <meta property="twitter:title" content="Chill. {$controller->get_og_title()}">
    {else}
    ...
    <meta property="twitter:url" content="{$controller->get_og_url()}">
    {else}
    <meta property="og:title" content="Chill">
    ...
    <meta property="twitter:image" content="{$controller->get_og_image_url()}">
    {else}
