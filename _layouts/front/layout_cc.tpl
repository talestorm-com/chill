...
<head>
    ...
    <meta property="og:image" content="https://chillvision.ru/assets/chill/images/logo_out.jpg?v={$smarty.now}">
    <meta property="twitter:image" content="https://chillvision.ru/assets/chill/images/logo_out.jpg?v={$smarty.now}">
...
<body>
    ...
    <div id="logaaa" style="display:none;">{get_user_auth_status}</div>
    ...
    {include './cookie.tpl'}
    <!--{include './prez.tpl'}-->
    <!--{include './mob_only.tpl'}-->
    {include './prezpromo.tpl'}
